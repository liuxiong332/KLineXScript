pub const EXP_VAL_BUT_GET_VAL: &'static str = "Expect {}, But get {}.";
pub const NO_FIELD_IN_OBJECT: &'static str = "No field named {} found for {}.";
...
pub const INPUT_SRCS: &'static str = "The input source should only be one of {}.";
